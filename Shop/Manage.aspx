<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Shop.Manage" %>
...
<form runat="server">
 ...
 <div class="container body-content">
   ...
   <div class="jumbotron">
    <div class="container ">
        <div class="starter-template">
            <h1 style="font-family: 微软雅黑; font-size: 85px">管&nbsp;&nbsp;&nbsp; 理&nbsp;&nbsp;&nbsp;    员&nbsp;&nbsp;&nbsp;   界&nbsp;&nbsp;&nbsp;面</h1>
            ...
            <p>
                <br />
                <asp:Button ID="books" runat="server" Text="书籍管理" Height="90px" OnClick="shuju_Click" Width="174px" style="font-size:30px"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <asp:Button ID="users" runat="server" Text="用户管理" Height="90px"  Width="174px" style="font-size:30px" OnClick="users_Click"/>
            </p>
        </div>
    </div><!--/.container-->
   </div><!--/.jumbotron--> 
  ...
  <div class="row">
    ...
    <div class="col-md-4">
        <h2>数据结构</h2>
        <p>  <img alt="图片显示失败" src="Image/数据结构.jpg" width="191" height="201" /></p>
